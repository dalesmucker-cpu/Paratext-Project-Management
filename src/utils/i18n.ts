...
const en: Dict = {
  ...
  'pr.deleteConfirm': 'Are you sure you want to delete this pull request? This action cannot be undone.',
  ...
  'pr.emailConfigRequired': 'Please configure the consultant or organization email address in Settings first.',
...
const es: Dict = {
  ...
  'pr.deleteConfirm': '¿Estás seguro de que deseas eliminar este pull request? Esta acción no se puede deshacer.',
  ...
  'pr.emailConfigRequired': 'Por favor configure el correo del asesor o de la organización en la Configuración primero.',
