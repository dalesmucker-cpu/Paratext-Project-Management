...
const en: Dict = {
  ...
  'pr.altInputPlaceholder': 'Suggest an alternative translation…',
  'pr.suggest': 'Suggest',
  'pr.altSuggested': 'Alternative translation suggested',
  ...
  'pr.createDescriptionPlaceholder':
    'Define the general decision or translation philosophy proposed...',
  ...
  'pr.deletePr': 'Delete PR',
  'pr.deleteConfirm':
    'Are you sure you want to delete this pull request? This action cannot be undone.',
  'pr.deleteSuccess': 'PR #%1 deleted successfully.',
  'pr.yes': 'Yes',
  'pr.cancel': 'Cancel',
  'pr.deleteError': 'Error deleting PR: %1',
  'pr.editPr': 'Edit Proposal',
  'pr.editTitle': 'Edit Proposal',
  'pr.saveChanges': 'Save Changes',
  'pr.deleteCommentTitle': 'Delete Comment',
  'pr.deleteCommentConfirm':
    'Are you sure you want to delete this comment? This action cannot be undone.',
  'pr.prUpdated': 'PR updated successfully.',
  'pr.emailReviewers': 'Email Reviewers',
  'pr.emailConfigTitle': 'Reviewer E-mails',
  'pr.consultantEmailLabel': 'Consultant Email',
...
const es: Dict = {
  ...
  'pr.altInputPlaceholder': 'Sugerir una traducción alternativa…',
  'pr.suggest': 'Sugerir',
  'pr.altSuggested': 'Traducción alternativa sugerida',
  ...
  'pr.createDescriptionPlaceholder':
    'Defina la decisión general o la filosofía de traducción propuesta...',
  ...
  'pr.deletePr': 'Eliminar PR',
  'pr.deleteConfirm':
    '¿Estás seguro de que deseas eliminar este pull request? Esta acción no se puede deshacer.',
  'pr.deleteSuccess': 'PR #%1 fue eliminado con éxito.',
  'pr.yes': 'Sí',
  'pr.cancel': 'Cancelar',
  'pr.deleteError': 'Error al eliminar el PR: %1',
  'pr.editPr': 'Editar Propuesta',
  'pr.editTitle': 'Editar Propuesta',
  'pr.saveChanges': 'Guardar Cambios',
  'pr.deleteCommentTitle': 'Eliminar Comentario',
  'pr.deleteCommentConfirm':
    '¿Estás seguro de que deseas eliminar este comentario? Esta acción no se puede deshacer.',
  'pr.prUpdated': 'PR actualizado con éxito.',
  'pr.emailReviewers': 'Enviar por Correo',
  'pr.emailConfigTitle': 'Correos de Revisores',
  'pr.consultantEmailLabel': 'Correo del Asesor',
